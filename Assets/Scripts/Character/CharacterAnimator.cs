...
public class CharacterAnimator : MonoBehaviour
{
    ...
    public void UpdateAnimatorMovementParameters(float horizontalValue, float verticalValue, bool isSprinting)
    {
        ...
        characterManager.characterAnimator.SetFloat(HorizontalValue, horizontal, 0.1f, Time.deltaTime);
        characterManager.characterAnimator.SetFloat(VericalValue, vertical, 0.1f, Time.deltaTime);
    }
    ...
    public virtual void PlayTargetActionAnimation(string targetAnimationName, bool isPerformingAction, bool applyRootMotion = true, bool canMove = false, bool canRotate = false)
    {
        ...
        characterManager.characterAnimator.CrossFade(targetAnimationName, 0.2f);
